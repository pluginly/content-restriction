...
console.log('content_restriction_admin : ', content_restriction_admin );
const items = [
  {
    key: 'rules',
    label: (
  ...
  },
  {
    ...
    label: (
      ...
      : <Link to="/license" className="content-restriction__menu__single">{__( 'License', 'content-restriction' )}</Link>
    ),
  },
];
